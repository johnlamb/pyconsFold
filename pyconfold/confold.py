...
import sys
import datetime
from confold_helpers import check_programs,\
                            process_parameters,\
                            build_extended, xyz_pdb,\
                            contact_restraints, sec_restraints, build_models,\
                            assess_dgsa
from confold_libs import load_ss_restraints
...
shutil.copy(os.path.join(module_base,  "gseq.inp"),
            os.path.join(dir_out, "stage1/"))
shutil.copy(os.path.join(module_base, "extn.inp"),
            os.path.join(dir_out, "stage1/"))
shutil.copy(os.path.join(module_base, "dgsa.inp"),
            os.path.join(dir_out, "stage1/"))
shutil.copy(os.path.join(module_base, "scalecoolsetupedited"),
            os.path.join(dir_out, "stage1/"))
shutil.copy(os.path.join(module_base, "scalehotedited"),
            os.path.join(dir_out, "stage1/"))
